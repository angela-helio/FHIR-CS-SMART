...
public class AuthController {
    ...
    public RedirectView start(HttpSession session) {
        try {
            ...
            RedirectView rv = new RedirectView("/?error=" + url("auth_start_error: " + e.getMessage()));
            rv.setExposeModelAttributes(false);
            return rv;
        }
    }
    ...
    public RedirectView callback(@RequestParam(name = "code", required = false) String code,
        ...
        try {
            ...
            if (code == null || code.isBlank()) {
                RedirectView rv = new RedirectView("/?error=" + url("no_authorization_code"));
                rv.setExposeModelAttributes(false);
                return rv;
            }
            ...
            if (verifier == null || tokenEndpoint == null) {
                RedirectView rv = new RedirectView("/?error=" + url("missing_session_data"));
                rv.setExposeModelAttributes(false);
                return rv;
            }
            ...
            RedirectView rv = new RedirectView("/?error=" + url("callback_error: " + e.getMessage()));
            rv.setExposeModelAttributes(false);
            return rv;
        }
    }
